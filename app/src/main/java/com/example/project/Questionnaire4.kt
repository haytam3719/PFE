...
import com.example.project.databinding.Questionnaire4Binding
...
class Questionnaire4 : Fragment() {
    ...
    private var _binding: Questionnaire4Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = Questionnaire4Binding.inflate(inflater, container, false)
        ...
        buttonOui.setOnClickListener {
            ...
            questionnaireViewModel.updateQuestion4(true)
        }
        ...
        buttonNext.setOnClickListener {
            if(!(binding.customRadioButton.isChecked) && !(binding.customRadioButton1.isChecked)){
                ...
                questionnaireViewModel.updateQuestion4(false)
            }
