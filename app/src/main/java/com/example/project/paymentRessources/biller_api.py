    ...
    if request.method == 'GET':
        ...
        if payment_id:
            ...
            if result.is_success():
                ...
                return redirect('http://127.0.0.1:5000/make_payment?bill_id={}&payment_id={}'.format(bill_id, payment_id))
                #return redirect(f'http://127.0.0.1:5000/merchant_approval?payment_id={payment_id}')
                
                #return jsonify({"message": "Payment details retrieved successfully", "payment_details": payment_details}), 200
...
def notify_api_gateway(payment_info):
    api_gateway_url = 'http://125.0.0.1:5000/merchant_approval'
